...
namespace Marketplace.Migrations
{
    ...
    [Migration("20230120204350_AddedUserRoleTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.Models.Entities.UserRole", b =>
                {
                    b.Property<Guid>("UserRoleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            UserRoleId = new Guid("5f32b848-3a99-4f4c-b856-f5dd65406bb9"),
                            RoleType = "ConsumerOnly"
                        },
                        new
                        {
                            UserRoleId = new Guid("95f3814a-3410-4424-af1a-3d509dd9a923"),
                            RoleType = "Seller"
                        },
                        new
                        {
                            UserRoleId = new Guid("ffb27cec-c146-43d9-83df-c20c40d01aff"),
            ...
            modelBuilder.Entity("Marketplace.Models.Entities.User", b =>
                {
                    b.HasOne("Marketplace.Models.Entities.UserRole", null)
                        .WithMany("Users")
